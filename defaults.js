...
pref("extensions.zotfile.pdfExtraction.formatNoteTitle", "<p><b>%(category) %(title) (%(date))</b><p>");
...
pref("extensions.zotfile.pdfExtraction.separateNotes", true);
pref("extensions.zotfile.pdfExtraction.defaultCategory", "General");
pref("extensions.zotfile.pdfExtraction.separateByColor", false);
